            ...
            <div class="col-md-6">
				...
				<?php if ($currentProduct['prd_on_offer']): ?>
                    <p><strong>Precio:</strong>
                        <span class="text-muted text-decoration-line-through"><?php echo htmlspecialchars($currentProduct['prd_price']); ?>€</span>
                        <span class="badge bg-success" style="font-size: 1rem;"><?php echo htmlspecialchars($currentProduct['prd_offer_price']); ?>€</span>
                    </p>
                    <div class="badge bg-danger text-white" style="font-size: 1rem;">Oferta</div>
				<?php else: ?>
                    <p><strong>Precio:</strong>
                        <span class="badge bg-success" style="font-size: 1rem;"><?php echo htmlspecialchars($currentProduct['prd_price']); ?>€</span>
                    </p>
				<?php endif; ?>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="card-text"><small class="text-muted">Publicado por
                                <strong><?php echo htmlspecialchars($review['usu_name']); ?></strong>
                                el <?php echo date('d/m/Y H:i', strtotime($review['rev_datetime'])); ?></small></p>
						<?php if (isset($_SESSION['UserID']) && $_SESSION['UserID'] == $review['rev_user_id']): ?>
                            ...
                            <button class="btn btn-secondary btn-sm" onclick="editReview('<?php echo $review['rev_id']; ?>', '<?php echo $review['rev_rating']; ?>', '<?php echo htmlspecialchars(addslashes($review['rev_message'])); ?>')">
