        ...
        <div class="col-md-12">
            ...
            <table class="table">
				...
				<?php foreach ($cartProducts as $product): ?>
                    <tr>
                        ...
                        <td><?php echo number_format($product['prd_price'] * $_SESSION['cart'][$product['prd_id']], 2); ?>
                            €
                        </td>
                    </tr>
				<?php endforeach; ?>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="mt-3">
                ...
                <div class="form-check mt-3">
                    ...
                    <label class="form-check-label" for="terms">He leído y acepto los <a href="Terms.php">términos y
                            condiciones</a>.</label>
                </div>
                <p>
