    ...
    else
    {
        ...
        if ($has2FA)
        {
            ...
            else
            {
                ...
                error_log("Error al desactivar 2FA para el usuario con ID: $UserId");
            }
        }
        else
        {
            ...
            $QrCodeImage = $Tfa->getQRCodeImageAsDataUri($UserEmail, $Secret);
            if (UpdateUser2FASecret($UserId, $Secret))
            {
            ...
            else
            {
                ...
                error_log("Error al activar 2FA para el usuario con ID: $UserId");
            }
        }
    }
}
