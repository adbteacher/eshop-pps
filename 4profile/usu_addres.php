                    ...
                    <div class="card h-100 position-relative">
                        <div class="card-body">
                            <p class="card-text">
                                ...
                                <?php echo $address['adr_city'] . ', ' . $address['adr_state'] . ' ' . $address['adr_postal_code']; ?><br>
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <?php if (!$address['adr_is_main']) : ?>
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                        ...
                                        <button type="submit" name="submitMainAddress" class="btn btn-success">Principal</button>
                                    </form>
                                <?php endif; ?>
                                ...
                                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="ms-2" onsubmit="return confirmDelete();">
                                    ...
                                    <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                                    <button type="submit" name="submitDeleteAddress" class="btn btn-danger">Eliminar</button>
                                </form>
                            </div>
                        </div>
                    </div>
