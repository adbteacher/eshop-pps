            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <div class="mb-3">
                    ...
                    <select id="adr_country" name="adr_country" class="form-control" required>
                        <option value="Estados Unidos" <?php if ($edit_adress['adr_country'] === 'Estados Unidos') echo 'selected'; ?>>Estados Unidos</option>
                        <option value="Alemania" <?php if ($edit_adress['adr_country'] === 'Alemania') echo 'selected'; ?>>Alemania</option>
                        <option value="España" <?php if ($edit_adress['adr_country'] === 'España') echo 'selected'; ?>>España</option>
                        <option value="Francia" <?php if ($edit_adress['adr_country'] === 'Francia') echo 'selected'; ?>>Francia</option>
                    </select>
                </div>
                <div class="mb-3">
